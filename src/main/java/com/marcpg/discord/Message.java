...
public class Message {
    /** Modifications to a message, that currently only prevent things from happening. */
    public enum Flag {
        /** Suppresses all embeds generated by links. */ SUPPRESS_EMBEDS(4),
        /** Suppresses the message from notifying members. */ SUPPRESS_NOTIFICATIONS(4096);

        /** The raw integer as it's used in the Discord API. */
        public final int raw;

        Flag(int raw) { this.raw = raw; }
    }
     ...
     * @param flags The message flags/modifications that should be applied.
     */
    public Message(String threadName, boolean tts, String content, List<Embed> embeds, Flag... flags) {
     ...
     * @param flags The message flags/modifications that should be applied.
     */
    public Message(String content, List<Embed> embeds, Flag... flags) {
        this.content = content;
        this.embeds = embeds;
        this.flags = flags;
    }
     ...
     * @param flags The message flags/modifications that should be applied.
     */
    public Message(String content, Flag... flags) {
        this.content = content;
        this.flags = flags;
    }
     ...
     * @param flags The message flags/modifications that should be applied.
     */
    public Message(String username, URL avatarUrl, String threadName, boolean tts, String content, List<Embed> embeds, Flag... flags) {
     ...
     * @param flags The message flags/modifications that should be applied.
     */
    public Message(String username, URL avatarUrl, String content, List<Embed> embeds, Flag... flags) {
        this.username = username;
        this.avatarUrl = avatarUrl;
        this.content = content;
        this.embeds = embeds;
     ...
     * @param flags The message flags/modifications that should be applied.
     */
    public Message(String username, URL avatarUrl, String content, Flag... flags) {
        this.username = username;
        this.avatarUrl = avatarUrl;
        this.content = content;
        this.flags = flags;
    ...
    public String build() {
        if (isEmpty()) {
            ...
            if (flags != null && flags.length > 0)
                builder.append("\"flags\":").append(Arrays.stream(flags).mapToInt(flag -> flag.raw).sum()).append(",");
    ...
    /**
     * Gets all applied message flags/modifications.
     * @return All applied flags/modifications.
     */
    ...
    /**
     * Sets all applied message flags/modifications.
     * @param flags All applied flags/modifications.
     * @return A reference to this object.
     */
    public Message setFlags(Flag... flags) {
        this.flags = flags;
        return this;
    }
